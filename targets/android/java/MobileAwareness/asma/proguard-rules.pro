...
#-keep public class com.additionsecurity.** { public *; }
#-keep class com.additionsecurity.MobileAwareness$B { *; }
#-keep class org.apache.harmony.dalvik.ddmc.** { *; }

#-keep public class com.additionsecurity.MobileAwareness** { public *; }
#-keep public class com.additionsecurity.MobileAwareness$* { public *; }
#-keep class com.additionsecurity.IMobileAwarenessCallback { public *; }
